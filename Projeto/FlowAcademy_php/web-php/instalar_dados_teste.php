...
<body class="auth-shell">
  ...
  <main class="auth-card">
    ...
    <p class="auth-subtitle">Use depois de importar o arquivo <strong>database/flow 3.0.sql</strong> no MySQL.</p>
    ...
    <?php if ($mensagem): ?>
      ...
      <div class="stack">
        ...
        <div class="quick-actions">
          <a class="quick-action" href="login.php"><strong>admin@flowacademy.com</strong><span>Perfil admin</span></a>
          <a class="quick-action" href="login.php"><strong>professor@flowacademy.com</strong><span>Perfil professor</span></a>
          <a class="quick-action" href="login.php"><strong>aluno@flowacademy.com</strong><span>Perfil aluno</span></a>
        </div>
      </div>
    <?php else: ?>
